...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "Onchain succession protocol", // 30 characters, no emojis or special characters, short description under app name
      description: "Onchain succession protocol", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "Onchain succession protocol", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
